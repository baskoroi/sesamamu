...
struct MultilineTextField: View {
    ...
    var body: some View {
        UITextViewWrapper(text: self.internalText, calculatedHeight: $viewHeight, charLimitInput: charTextViewLimit, onDone: onCommit)
    ...
    init (_ placeholder: String = "", text: Binding<String>, charLimit: Int, onCommit: (() -> Void)? = nil) {
        self.placeholder = placeholder
        self.onCommit = onCommit
        self._text = text
        self.charTextViewLimit = charLimit
...
private struct UITextViewWrapper: UIViewRepresentable {
    ...
    func makeCoordinator() -> Coordinator {
        return Coordinator(text: $text, height: $calculatedHeight, charLimit: charLimitInput, onDone: onDone)
    }
